<template>
    <div class="table">
        ...
        <el-dialog title="添加歌曲" :visible.sync="centerDialogVisible" width="400px" center>
            <el-form v-model="registerForm" ref="registerForm" label-width="80px" enctype="multipart/form-data" id="tf">
                <div>
                    <label>歌名</label>
                ...
                <div>
                    <label>专辑</label>
                    <el-input type="text" name="introduction" v-model="registerForm.singerName"></el-input>
                </div>
                <div>
                    <label>歌词</label>
                ...
                <div>
                    <br>
                    <label>歌曲上传</label>
                    <el-input type="file" name="file" v-model="registerForm.introduction"></el-input>
                </div>
            </el-form>
            <span slot="footer">
...
export default {
  ...
  methods: {
    ...
    // 更新歌曲url
    uploadSongUrl (id) {
      console.log(`${this.$store.state.HOST}/song/updateSongUrl?id=${id}`);
